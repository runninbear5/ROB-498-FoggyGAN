...
class CC_Module(nn.Module):
    ...
    def __init__(self):
        ...
        self.layer1_1 = Conv2D_pxp(1, 32, 5,1,2)
        self.layer1_2 = Conv2D_pxp(1, 32, 5,1,2)
        self.layer1_3 = Conv2D_pxp(1, 32, 5,1,2)

        self.layer2_1 = Conv2D_pxp(96, 32, 5,1,2)
        self.layer2_2 = Conv2D_pxp(96, 32, 5,1,2)
        self.layer2_3 = Conv2D_pxp(96, 32, 5,1,2)
        
        self.local_attn_r = CBAM(64)
        self.local_attn_g = CBAM(64)
        self.local_attn_b = CBAM(64)

        self.layer3_1 = Conv2D_pxp(192, 1, 5,1,2)
        self.layer3_2 = Conv2D_pxp(192, 1, 5,1,2)
        self.layer3_3 = Conv2D_pxp(192, 1, 5,1,2)
